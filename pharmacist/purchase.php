...
<body>
    ...
    <div class="dash-body">
        <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
            <tr>
                <td width="13%">
                    <a href="purchase.php"><button class="login-btn btn-primary-soft btn btn-icon-back"
            ...
            <tr>
                <?php
                $count = $conn->query("SELECT * from purchase");
                    ...
                    <center>
                        <div class="abc scroll">
                            <table width="93%" class="sub-table scrolldown" border="0">
                                ...
                                <tbody>
                                    <?php
                                    $all_purchase = $conn->query("SELECT c.category_name,p.purchase_date,p.purchase_id,
                                    p.iterm_name,p.iterm_price,p.quantity,p.purchase_description,i.stock
                                    from category c,iterm i,purchase p where c.category_id = i.category_id 
                                    and c.category_id = p.category_id order by p.purchase_date DESC");
                                    if ($all_purchase->num_rows > 0) {

                                        while ($row = $all_purchase->fetch_array()) {
                                            echo '<tr>
                                        <td> &nbsp;' .
                                                $row["iterm_name"]
                                                . '</td>
                            ...
                            ' . $row["purchase_date"] . '
                                        ...
                                        <a href="?action=edit&id=' . $row["purchase_id"] . '&error=0" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-edit"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Edit</font></button></a>

                                       &nbsp;&nbsp;&nbsp;
                                       <a href="?action=drop&id=' . $row["purchase_id"] . '&name=' . $row["iterm_name"] . '" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-delete"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Remove</font></button></a>
                                        </div>
                                        </td>
                                    </tr>';
                                        }
                                    ...
                                    <br>
                                    <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">No purchase available now</p>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
        ...
        if ($action == 'drop') {
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <a class="close" href="purchase.php">&times;</a> 
                        <div style="display: flex;justify-content: center;">
                        <div class="abc">
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Add New Purchase.</p><br><br>
                                </td>
                            </tr>
                            <form action="../action/action_add_purchase.php" method="POST" class="add-new-form">
                        ...
                        <tr>
                            <td class="label-td" colspan="2">
                                <input type="date" name="purchase_date" class="input-text" required><br>
                            </td>
                        </tr>
